package site.yangpan.redis.consumer;
...
public class DubboRegistryRedisConsumerApplication {

    public static void main(String[] args) {
        SpringApplication.run(DubboRegistryRedisConsumerApplication.class, args);
    }
