package site.yangpan.redis.provider;
...
public class DubboRegistryRedisProviderApplication {

    public static void main(String[] args) {
        SpringApplication.run(DubboRegistryRedisProviderApplication.class, args);
    }
